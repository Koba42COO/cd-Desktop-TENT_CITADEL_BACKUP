#!/usr/bin/env python3
"""TENT CURRICULUM SEEDER v2 - Expanded University Catalog"""
...
CURRICULUM = {
    ...
    "mathematics core": {
        ...
        "MATH331 Numerical Linear Algebra": ["matrix factorizations", "iterative solvers", "conditioning", "sparse matrices", "stability and error"],
        "MATH341 Applied PDEs": ["heat, wave, laplace equations", "boundary and initial conditions", "separation of variables", "fourier methods", "applications"],
        "MATH351 Convex Optimization": ["convex sets and functions", "kkt conditions", "duality theory", "first-order methods", "applications"],
        "MATH361 Numerical Optimization": ["gradient and newton methods", "constrained optimization", "stochastic optimization", "quasi-newton methods", "line search and trust regions"],
        "MATH371 Dynamical Systems": ["phase space analysis", "fixed points and stability", "bifurcations", "chaos basics", "applications"],
        "MATH381 Information Theory": ["entropy and mutual information", "source coding", "channel coding", "rate-distortion", "applications"],
        "MATH391 Randomized Algorithms": ["probabilistic analysis", "hashing and sketches", "monte carlo vs las vegas", "random walks", "streaming algorithms"],
    },
    "computer science core": {
        ...
        "CS301 Algorithms II": ["advanced graph algorithms", "network flow", "approximation algorithms", "randomized algorithms", "np-completeness"],
        "CS311 Distributed Systems": ["consistency models", "replication and consensus", "time and clocks", "fault models", "distributed transactions"],
        "CS321 Systems Programming": ["memory safety", "concurrency primitives", "low-level i/o", "profiling and debugging", "performance tuning"],
        "CS331 Databases II": ["query planning", "storage engines", "index structures", "distributed databases", "replication and sharding"],
        "CS341 Computer Security": ["threat modeling", "secure protocols", "application security", "cryptographic systems", "incident response"],
        "CS351 Parallel and GPU Computing": ["parallel paradigms", "gpu programming model", "memory hierarchies", "performance profiling", "scalability"],
        "CS361 Formal Methods (Intro)": ["specification", "model checking", "program verification", "temporal logic", "safety properties"],
        "CS371 Compilers II": ["intermediate representations", "optimization passes", "register allocation", "code generation", "toolchain integration"],
        "CS381 Language Modeling Systems": ["tokenization and vocabularies", "training pipelines", "serving architectures", "efficiency optimizations", "safety considerations"],
        "CS391 Systems Design Practicum": ["requirements analysis", "scalability planning", "reliability testing", "observability", "postmortem analysis"],
    },
    "data science core": {
        ...
        "DS281 Data Governance and Stewardship": ["data catalogs", "access control", "quality policies", "retention and deletion", "compliance basics"],
        "DS291 Applied Time Series": ["decomposition", "forecasting models", "state space models", "anomaly detection", "evaluation metrics"],
    },
    "machine learning and ai": {
        ...
        "ML301 Representation Learning": ["contrastive learning", "self-supervised objectives", "embedding evaluation", "transfer learning", "domain adaptation"],
        "ML311 Scaling Laws and Training Infrastructure": ["compute and data scaling", "parallel training", "checkpointing", "mixed precision", "cost optimization"],
        "ML321 Retrieval-Augmented Generation": ["indexing and vector search", "retrieval strategies", "rag evaluation", "hallucination control", "tool integration"],
        "ML331 Multimodal AI": ["vision-language models", "audio-text models", "cross-modal alignment", "fusion strategies", "evaluation"],
        "ML341 Advanced RL": ["offline rl", "model-based rl", "hierarchical rl", "multi-agent rl", "safety in rl"],
        "ML351 AI Safety and Governance": ["risk assessment", "red teaming workflows", "alignment taxonomies", "policy frameworks", "responsible deployment"],
        "ML361 Efficient AI Systems": ["quantization", "distillation", "pruning and sparsity", "serving optimization", "edge deployment"],
        "ML371 Causal ML": ["causal discovery", "treatment effect estimation", "invariant prediction", "counterfactual modeling", "applications"],
        "ML381 LLM Systems and Tooling": ["prompting and control", "tool use and agents", "guardrails", "evaluation harnesses", "system reliability"],
    },
    "systems and infrastructure": {
        ...
        "SYS291 Release Engineering": ["build pipelines", "artifact management", "environment promotion", "rollbacks", "change management"],
        "SYS301 Reliability Engineering": ["error budgets", "capacity planning", "chaos engineering", "incident command", "resilience audits"],
        "SYS311 Security Operations": ["monitoring and detection", "vulnerability management", "threat intelligence", "incident response drills", "forensics basics"],
    },
    "physics core": {
...
def main():
    print("=" * 60)
    print("TENT CURRICULUM SEEDER v2 (EXPANDED)")
    print("=" * 60)
